...
public class External_variables_Manager {
	private static final CustomLogger LOGGER = new CustomLogger(External_variables_Manager.class);
	private static Map<String, Double> external_variables = new HashMap<>();

	private static boolean useExternal_variables = false;
