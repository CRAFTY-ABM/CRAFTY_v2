...
- If `regionalisation: true`, you typically provide *one demand file per region*.
...
- `services/demand/<scenario>/...csv` (EU-level, and per region if `regionalisation: true`)
